...
class EndpointsApi(object):
    ...
    def endpoint_docker_container_status(self, id, cid, **kwargs):
        """Get container status

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_status(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: Endpoint identifier (required)
        :param int id: Container identifier (required)
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.endpoint_docker_container_status_with_http_info(id, cid, **kwargs)
        else:
            (data) = self.endpoint_docker_container_status_with_http_info(id, cid, **kwargs)
            return data

    def endpoint_docker_container_status_with_http_info(self, id, cid, **kwargs):
        """Get docker container status

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_status_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method endpoint_docker_container_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `endpoint_docker_container_status`")
        # verify the required parameter 'cid' is set
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `endpoint_docker_container_status`")
        ...
        return self.api_client.call_api(
            '/endpoints/{id}/docker/containers/{cid}/stats', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def endpoint_docker_container_stop(self, id, cid, **kwargs):
        """Stop docker container

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_stop(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.endpoint_docker_container_stop_with_http_info(id, cid, **kwargs)
        else:
            (data) = self.endpoint_docker_container_stop_with_http_info(id, cid, **kwargs)
            return data

    def endpoint_docker_container_stop_with_http_info(self, id, cid, **kwargs):
        """Stop docker container

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_stop_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method endpoint_docker_container_stop" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `endpoint_docker_container_stop`")
        # verify the required parameter 'cid' is set
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `endpoint_docker_container_stop`")
        ...
        return self.api_client.call_api(
            '/endpoints/{id}/docker/containers/{cid}/stop', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def endpoint_docker_container_start(self, id, cid, **kwargs):
        """Start docker container

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_start(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.endpoint_docker_container_start_with_http_info(id, cid, **kwargs)
        else:
            (data) = self.endpoint_docker_container_start_with_http_info(id, cid, **kwargs)
            return data

    def endpoint_docker_container_start_with_http_info(self, id, cid, **kwargs):
        """Start docker container

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_start_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method endpoint_docker_container_start" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `endpoint_docker_container_start`")
        # verify the required parameter 'cid' is set
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `endpoint_docker_container_start`")
        ...
        return self.api_client.call_api(
            '/endpoints/{id}/docker/containers/{cid}/start', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def endpoint_docker_container_restart(self, id, cid, **kwargs):
        """Restart docker container

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_restart(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.endpoint_docker_container_restart_with_http_info(id, cid, **kwargs)
        else:
            (data) = self.endpoint_docker_container_restart_with_http_info(id, cid, **kwargs)
            return data

    def endpoint_docker_container_restart_with_http_info(self, id, cid, **kwargs):
        """Restart docker container

        Retrieve details abount an endpoint. **Access policy**: restricted
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_docker_container_restart_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method endpoint_docker_container_restart" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `endpoint_docker_container_restart`")
        # verify the required parameter 'cid' is set
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `endpoint_docker_container_restart`")
        ...
        return self.api_client.call_api(
            '/endpoints/{id}/docker/containers/{cid}/restart', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
