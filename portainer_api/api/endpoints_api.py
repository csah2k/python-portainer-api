...
class EndpointsApi(object):
    ...
    def endpoint_docker_container_status_with_http_info(self, id, cid, **kwargs):
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `endpoint_inspect`")
        # verify the required parameter 'cid' is set
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `endpoint_inspect`")
